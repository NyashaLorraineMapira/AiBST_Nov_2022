...
```{r}
gene_table <- read_excel("GSE111543.xlsx", "gene_info")
...
```{r}
go_table <- read_excel("GSE111543.xlsx", "go_db")
...
```{r}
go_info <- read_excel("GSE111543.xlsx", "go_info")
